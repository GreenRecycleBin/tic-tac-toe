...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__35050__auto__,writer__35051__auto__,opt__35052__auto__){
return cljs.core._write.call(null,writer__35051__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__37284 = o;
(G__37284[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__37285__delegate = function (args){
...
while (G__37286__i < G__37286__a.length) {G__37286__a[G__37286__i] = arguments[G__37286__i + 0]; ++G__37286__i;}
  args = new cljs.core.IndexedSeq(G__37286__a,0,null);
} 
return G__37285__delegate.call(this,args);};
G__37285.cljs$lang$maxFixedArity = 0;
G__37285.cljs$lang$applyTo = (function (arglist__37287){
var args = cljs.core.seq(arglist__37287);
return G__37285__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__34427__auto__ = !((jsprops == null));
if(and__34427__auto__){
var and__34427__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__34427__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__34427__auto____$1;
}
} else {
...
var G__37293 = jsprops;
(G__37293["defaultValue"] = value);

(G__37293["onChange"] = ((function (G__37293,v,value,on_change){
return (function (p1__37290_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__37290_SHARP_);
});})(G__37293,v,value,on_change))
);

(G__37293["ref"] = ((function (G__37293,v,value,on_change){
return (function (p1__37291_SHARP_){
return (this$["cljsInputElement"] = p1__37291_SHARP_);
});})(G__37293,v,value,on_change))
);
...
var vec__37300 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__37300,(0),null);
var id = cljs.core.nth.call(null,vec__37300,(1),null);
var class$ = cljs.core.nth.call(null,vec__37300,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___37305 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___37305 == null)){
} else {
var key_37306 = temp__4661__auto___37305;
(jsprops["key"] = key_37306);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__37308 = (new reagent.impl.template.NativeWrapper());
(G__37308["name"] = c);
...
var len__35552__auto___37314 = arguments.length;
var i__35553__auto___37315 = (0);
while(true){
if((i__35553__auto___37315 < len__35552__auto___37314)){
args__35559__auto__.push((arguments[i__35553__auto___37315]));

var G__37316 = (i__35553__auto___37315 + (1));
i__35553__auto___37315 = G__37316;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__35560__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37312){
var G__37313 = cljs.core.first.call(null,seq37312);
var seq37312__$1 = cljs.core.next.call(null,seq37312);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__37313,seq37312__$1);
});
...
break;
default:
var G__37320 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__37320;
continue;
...
var n__35362__auto___37323 = a.length;
var i_37324 = (0);
while(true){
if((i_37324 < n__35362__auto___37323)){
(a[i_37324] = reagent.impl.template.as_element.call(null,(a[i_37324])));

var G__37325 = (i_37324 + (1));
i_37324 = G__37325;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__35362__auto___37326 = a.length;
var i_37327 = (0);
while(true){
if((i_37327 < n__35362__auto___37326)){
var val_37328 = (a[i_37327]);
if((cljs.core.vector_QMARK_.call(null,val_37328)) && ((reagent.impl.template.key_from_vec.call(null,val_37328) == null))){
(o["no-key"] = true);
} else {
}

(a[i_37327] = reagent.impl.template.as_element.call(null,val_37328));
...
var ctx = ({});
var vec__37333 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__37333,(0),null);
var derefed = cljs.core.nth.call(null,vec__37333,(1),null);
...
var G__37337 = (cljs.core.count.call(null,argv) - first_child);
switch (G__37337) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__37337){
...
//# sourceMappingURL=template.js.map?rel=1536657137592